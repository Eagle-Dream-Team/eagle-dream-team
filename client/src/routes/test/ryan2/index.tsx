...
export const Route = createFileRoute('/test/ryan2/')({
...
function RouteComponent() {
    ...
    return <>
        ...
        <div className="bg-gray-200 p-4">
            <div>Email</div>
            <input onChange={(e) => { setEmail(e.target.value) }} className="rounded border border-gray-700"></input>
            <div>Password</div>
            <input onChange={(e) => { setPassword(e.target.value) }} className="rounded border border-gray-700"></input>
        </div>
